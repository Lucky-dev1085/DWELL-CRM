...
export const ResetPasswordWrapper = styled.div`
  ...
  background: url(${BackgroundDemo}) no-repeat center center fixed;
...
export const ResetPasswordLogo = styled.a`
  display: flex;
...
export const ResetPasswordTitle = styled.h4`
  font-weight: ${props => props.theme.fontWeights.medium};
  color: ${props => props.theme.colors.colortx01};
  letter-spacing: -.5px;
`;

export const ResetPasswordText = styled.h6``;

export const ResetPasswordInfo = styled.p`
...
export const LinkResetPassword = styled.a`
    font-size: ${props => props.theme.fontSizes.sm};
